...
axes[0].plot(x_interpolated0, y_interpolated0, color='orange', label='interpolation, k = 3')
axes[0].scatter(x, df['Station_1'], color='black', label='data')
axes[0].set_title('station 1 data')
axes[0].set_ylabel('temperatures')
axes[0].legend(loc='upper right')

axes[1].plot(x_interpolated1, y_interpolated1, color='orange', label='interpolation, k = 2')
axes[1].scatter(x, df['Station_2'], color='black', label='data')
axes[1].set_title('station 2 data')
axes[1].set_ylabel('temperatures')
axes[1].legend(loc='upper right')

axes[2].plot(x_interpolated2, y_interpolated2, color='orange', label='interpolation, k = 1')
axes[2].scatter(x, df['Station_3'], color='black', label='data')
axes[2].set_title('station 3 data')
